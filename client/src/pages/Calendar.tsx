...
export default function Calendar() {
  ...
  if (isLoading || !isAuthenticated) {
    return <MainLayout title="Calendar"><div>Loading...</div></MainLayout>;
  }
        ...
        <Card className="material-shadow">
          <CardContent className="p-6">
            <div className="text-center py-20">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-2">Calendar Component</h3>
              <p className="text-muted-foreground mb-4">
                Full calendar functionality would be implemented here
              </p>
              <p className="text-sm text-muted-foreground">
                Features: Project timelines, task deadlines, team schedules, client meetings
              </p>
